...
export default function Home() {
  return (
    <main id='main' className='flex w-full flex-1 flex-col'>
      <section id='#download' className={cn("flex w-full flex-col items-center px-4 py-24 shadow-sm", "bg-gradient-to-r from-blue-600 to-purple-600")}>
        <h1 className={cn("px-2 text-center text-2x1 font-extrabold text-white sm:text-4x1")}>
